...
This specification defines implemented worktree behavior for `grafana_exec.create_silence`. Local validation and mock Grafana tests exist. The alerting revision has not been deployed; authenticated preview calls, live silence API behavior, and operation of the promoted Editor permission remain unverified.
